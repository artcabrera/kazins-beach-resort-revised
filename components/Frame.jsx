    ...
    <div className="h-fit w-full">
      ...
      <div className="h-screen w-full">
        ...
        <div className="h-screen w-full bg-black/25 px-10">
          ...
          <div className="-mt-48 flex h-full w-full flex-col items-center justify-between">
            <h3 className="mt-64 text-sm font-light tracking-[.2em] text-white">
              {pageTitle}
            </h3>
            <div className="h-fit w-full px-16 text-center font-italiana text-3xl font-light tracking-[.2em] text-white lg:px-40 lg:text-4xl">
        ...
        <div className="h-fit w-full bg-gray-100 pt-14 lg:h-screen">
          ...
          <div className="mx-8 flex h-fit flex-col border-t border-t-gray-300 lg:mx-16 lg:h-1/2">
            ...
            <div className="flex h-24 justify-center border-t border-t-gray-300 pt-12 text-sm text-gray-600 lg:h-1/5">
              2022 KAZIN&apos;S BEACH RESORT. ALL RIGHTS RESERVED.
            </div>
          </div>
        </div>
      </footer>
